  ...
  return (
    <div className="space-y-3.5 mb-6 sm:mb-8">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Filter by keyword, topic, or tags..."
          value={searchQuery}
        ...
        {searchQuery && (
          <button
            ...
            className="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 p-1.5 rounded-full hover:bg-slate-100 transition-colors"
          >
      ...
      {/* Category Pills with Smooth Momentum Touch Scroll */}
        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            <button
              ...
              className={`text-xs px-3.5 py-1.5 rounded-xl font-medium transition-all shrink-0 cursor-pointer whitespace-nowrap active:scale-95 ${
                active
